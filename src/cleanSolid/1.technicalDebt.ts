...
// ¿Qué es?
// Falta de calidad en el código, que genera una deuda que repercutirá en costos futuros. Como una posible re-factorización o mas.

// Costos económicos
// - Tiempo en realizar mantenimientos.
// - Tiempo en refactorizar código.
// - Tiempo en comprender el código.
// - Tiempo en adicional en la transferencia del código.
...
// Ya sea el clearInterval, el proveedor con recursos o el propio desarrollador dedicando tiempo a refactorizar o malgastando tiempo programando sobre un sistema frágil.
